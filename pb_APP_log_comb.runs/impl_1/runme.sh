...
HD_PWD='F:/Xilinx/Projects/S4_APP1/pb_APP_log_comb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Add1bitB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Add1bitB.tcl -notrace
